...
PhysicsListMessenger::PhysicsListMessenger(PhysicsList* pPhys)
  :fPPhysicsList(pPhys)
{   
  fPhysDir = new G4UIdirectory("/APEXG4MC/physics/");
  fPhysDir->SetGuidance("physics control.");

  fGammaCutCmd = new G4UIcmdWithADoubleAndUnit("/APEXG4MC/physics/setGCut",this);  
  ...
  fElectCutCmd = new G4UIcmdWithADoubleAndUnit("/APEXG4MC/physics/setECut",this);  
  ...
  fProtoCutCmd = new G4UIcmdWithADoubleAndUnit("/APEXG4MC/physics/setPCut",this);  
  ...
  fAllCutCmd = new G4UIcmdWithADoubleAndUnit("/APEXG4MC/physics/setCuts",this);
  ...
  fPListCmd = new G4UIcmdWithAString("/APEXG4MC/physics/addPhysics",this);
