...
PhysicsListMessenger::PhysicsListMessenger(PhysicsList* pPhys)
  :fPPhysicsList(pPhys)
{   
  fPhysDir = new G4UIdirectory("/APEXMC/physics/");
  fPhysDir->SetGuidance("physics control.");

  fGammaCutCmd = new G4UIcmdWithADoubleAndUnit("/APEXMC/physics/setGCut",this);  
  ...
  fElectCutCmd = new G4UIcmdWithADoubleAndUnit("/APEXMC/physics/setECut",this);  
  ...
  fProtoCutCmd = new G4UIcmdWithADoubleAndUnit("/APEXMC/physics/setPCut",this);  
  ...
  fAllCutCmd = new G4UIcmdWithADoubleAndUnit("/APEXMC/physics/setCuts",this);
  ...
  fPListCmd = new G4UIcmdWithAString("/APEXMC/physics/addPhysics",this);
